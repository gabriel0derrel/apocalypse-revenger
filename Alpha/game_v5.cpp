...
bool quadro=false, alcapao=false;
int inv_tam=4;
string inv[4]={"","","",""};
...
{
    int verbo_int;
    string verbo_v[7]={"ver", "usar", "pegar", "abrir", "entrar", "arrastar", "lutar"}; //vetor dos verbos
    for (int i = 0 ; i < 7; i++) {
...
{
    cout<<R"(Você veio da porta oeste.
No quarto há:
- cama
- tv
- mesa
...
void mensagem_quarto3()
{
    if(alcapao)
    {
        cout<<R"(Você veio da porta norte.
No armazém há:
- armario_1
- armario_2
- armario_3
...
int main()
{
    ...
    bool s_quadro = false;
    int lq = 1;
    int espelho_cont = 0, tv_cont = 0, alcapao_cont=0;
    string rq2[2]; //Vetor de retorno do quarto 2
