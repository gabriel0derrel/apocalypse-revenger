...
bool denovo = true, denovo2=true, denovo3=true, denovo4=true; //Determina se o mapa será repetido ou não
bool quadro=false, alcapao=false, parede=false, quebrou=false; //Estado dos itens
int inv_tam=4;
string inv[4]={"","","",""};
...
int main()
{
    ...
    int espelho_cont = 0, tv_cont = 0, alcapao_cont=0, porao_cont=0; //contadores
